...
namespace DemoMail.Test
{
    ...
    public partial class MailFeature : Xunit.IClassFixture<MailFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public virtual void SetFixture(MailFeature.FixtureData fixtureData)
        {
        }
        ...
        [Xunit.FactAttribute(DisplayName="Succsesful login to mail site")]
        [Xunit.TraitAttribute("FeatureTitle", "Mail")]
        [Xunit.TraitAttribute("Description", "Succsesful login to mail site")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                MailFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                MailFeature.FeatureTearDown();
            }
        }
    }
}
